...
/**
 * Variant 2 — Minimal with single CTA
 * Removes: subtitle paragraph, "See Our Work" secondary button
 * Keeps: badge, title, rotating text, single primary CTA, trust bar
 * Tighter spacing between title and CTA for a focused, premium layout
 */
...
export default function HeroVariant2({ preloaderDone }: HeroVariant2Props) {
    ...
    <section className="hero" id="hero">
      ...
      <div className="hero-content">
        <div className="hero-text">
          ...
          <h1 className="hero-title" style={{ marginBottom: '36px' }}>
          ...
          {/* Two CTAs — no subtitle paragraph */}
          <motion.div
            className="hero-actions"
            initial={{ opacity: 0, y: 20 }}
            animate={animateState === 'visible' ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
            transition={{ duration: 1.3, ease: entryEase, delay: 1.4 }}
          >
          ...
          <motion.div
            ...
            initial={{ opacity: 0, y: 20 }}
            animate={animateState === 'visible' ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
            transition={{ duration: 1.2, ease: entryEase, delay: 1.8 }}
          >
