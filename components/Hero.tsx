...
export default function Hero({ preloaderDone }: HeroProps) {
  ...
  // Rotating text carousel — exit fully completes before enter begins
  ...
  useEffect(() => {
    ...
    // Wait for hero entry animations to complete, then reveal first text
    const revealTimeout = setTimeout(() => {
      setActiveText(0);
      setAnimationsStarted(true);
    }, SCENE_START_DELAY);

    // Start cycling after first text has been shown
